package sg.edu.nus.projectsunshine.service;
...
import sg.edu.nus.projectsunshine.data.WeatherContract;

/**
 * Created by quang on 6/7/16.
 */
public class SunshineService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            String apiKey = "818e58e17b67901d2a3f85bf58ead191";
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            Log.v(LOG_TAG, "The location is " + cityName);
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.v(LOG_TAG, "Location is " + intent.getStringExtra(LOCATION_QUERY_EXTRA));
